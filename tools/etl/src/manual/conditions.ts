...
export const CONDITIONS: Entity[] = [
  ...
  condition({
    slug: "disabled",
    name: "Disabled",
    summary: "0 HP: nur Standard- ODER Bewegungsaktion, anstrengende Aktion kostet 1 HP",
    description:
  ...
  condition({
    slug: "dying",
    name: "Dying",
    summary: "−1 bis −9 HP: bewusstlos, verliert 1 HP pro Runde (10% Chance zu stabilisieren)",
    description:
  ...
  condition({
    slug: "stable",
    name: "Stable",
    summary: "bewusstlos, verliert aber keine HP mehr",
    description:
